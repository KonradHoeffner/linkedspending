...
/**
 * Class for writing a newsfeed. The feed is going to be displayed on the startpage of
...
public class NewsFeedWriter
{
	...
	/**
	 * Writes a xml-file into the newsfeed-folder. News get displayed on start screen of
	 * linkedspending.
	 * 
	 * @param title
	 *            the title the news should have
	 * @param description
	 *            a more detailed description of the news
	 */
