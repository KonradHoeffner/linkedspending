...
public class DataModel
{
	...
	static public class DataCube
	{
		...
		@Getter static final Resource	dataStructureDefinition	= ResourceFactory
	...
	static public class LSOntology
	{
		...
		@Getter static final Resource	countryComponent				= ResourceFactory.createResource(uri
																				+ "CountryComponentSpecification");
		@Getter static final Resource	dateComponentSpecification		= ResourceFactory.createResource(uri
																				+ "DateComponentSpecification");
		@Getter static final Resource	yearComponentSpecification		= ResourceFactory.createResource(uri
																				+ "YearComponentSpecification");
		@Getter static final Resource	currencyComponentSpecification	= ResourceFactory.createResource(uri
