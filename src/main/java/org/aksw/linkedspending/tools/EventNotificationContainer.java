...
public class EventNotificationContainer
{
	...
	public EventNotificationContainer()
	{
		notifications = new Vector<>();
	}

	/** @return Vector<EventNotification> notifications */
	public Vector<EventNotification> getEventNotifications()
	{
	...
	public int getTypeCount(EventNotification.EventType type, EventNotification.EventSource source)
	{
		...
		{
			if (n.getType() == type && n.getSource() == source) count++;
		}
		return count;
	}
	...
	/**
	 * Prints all occured events into a file named eventOutput. If this file already exists, output
	 * will be printed
